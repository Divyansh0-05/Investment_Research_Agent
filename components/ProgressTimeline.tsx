...
import type { ProgressEvent, ProgressStage } from "@/src/agent/types";
...
const STAGE_TITLES: Record<string, string> = {
  identify: "Identify company",
  research_news: "Scan recent news",
  research_financials: "Scan financials",
  research_competitors: "Scan competitive landscape",
  extract: "Synthesize findings",
  score: "Score investment dimensions",
  decide: "Form final verdict",
};
    ...
    <div className="card p-6 animate-fadeUp">
      ...
      <ol className="space-y-0">
        {STAGE_ORDER.map((stage, i) => {
          ...
          const isCurrent = !done && !hasError && (i === 0 || completedStages.has(STAGE_ORDER[i - 1]));
          const isParallelGroup = ["research_news", "research_financials", "research_competitors"].includes(stage);

          return (
            <li key={stage} className="relative pl-9 pb-5 last:pb-0">
